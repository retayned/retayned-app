...
export const APP_CSS = `
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rt-today-v4 { --dial-scale: 0.90; --dial-cs: 1.04; --dial-gap: 120px; --dial-label-w: 150px; --dial-stem-w: 220px; --dial-time-right: 200px; --dial-time-top: 44px; }
        @media (max-width: 1600px) { .rt-today-v4 { --dial-scale: 0.82; --dial-cs: 1.08; --dial-gap: 104px; --dial-label-w: 138px; --dial-stem-w: 205px; --dial-time-right: 235px; --dial-time-top: 100px; } }
        @media (max-width: 1440px) { .rt-today-v4 { --dial-scale: 0.74; --dial-cs: 1.12; --dial-gap: 88px; --dial-label-w: 118px; --dial-stem-w: 180px; --dial-time-right: 270px; --dial-time-top: 140px; } }
        @media (max-width: 1300px) { .rt-today-v4 { --dial-scale: 0.64; --dial-cs: 1.20; --dial-gap: 70px; --dial-label-w: 98px; --dial-stem-w: 155px; --dial-time-right: 305px; --dial-time-top: 175px; } }
        @media (max-width: 1200px) { .rt-today-v4 { --dial-scale: 0.56; --dial-cs: 1.28; --dial-gap: 58px; --dial-label-w: 84px; --dial-stem-w: 135px; --dial-time-right: 330px; --dial-time-top: 200px; } }
