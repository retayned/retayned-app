    ...
    <div style={{ position: "relative", width: "100%", height: "100%", minHeight: 0, overflow: "visible" }}>
      ...
      <div style={{ position: "absolute", right: VB_W + 8, top: "50%", transform: "translateY(-50%)", height: VB_H, width: 210, zIndex: 5 }}>
        {placements.length === 0 && earlierCount === 0 && laterCount === 0 && (
          <div className="rt-dial-cs" style={{ transformOrigin: "right center", position: "absolute", top: "50%", right: 0, transform: "translateY(-50%)", display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 5, maxWidth: "var(--dial-stem-w, 220px)", textAlign: "right" }}>
        ...
        {placements.map((p, i) => {
          ...
          >
            <div className="rt-dial-cs" style={{ transformOrigin: "top right", display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 1, minWidth: 0 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: p.isNext ? 700 : 600, color: p.isNext ? "#1C3224" : "#3A3A35", lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: "var(--dial-label-w, 150px)", textAlign: "right" }}>{p.e.title}</span>
              {p.e.client_name ? (
                <span style={{ fontSize: 10, color: p.isNext ? "#4A4F4A" : "#6B6B66", marginTop: 1, lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: "var(--dial-label-w, 150px)", textAlign: "right" }}>{p.e.client_name}</span>
              ) : null}
